...
static void initialize_c10_Model_01(SFc10_Model_01InstanceStruct *chartInstance);
static void initialize_params_c10_Model_01(SFc10_Model_01InstanceStruct
  *chartInstance);
static void enable_c10_Model_01(SFc10_Model_01InstanceStruct *chartInstance);
static void disable_c10_Model_01(SFc10_Model_01InstanceStruct *chartInstance);
static void c10_update_debugger_state_c10_Model_01(SFc10_Model_01InstanceStruct *
  chartInstance);
static const mxArray *get_sim_state_c10_Model_01(SFc10_Model_01InstanceStruct
  *chartInstance);
static void set_sim_state_c10_Model_01(SFc10_Model_01InstanceStruct
  *chartInstance, const mxArray *c10_st);
static void finalize_c10_Model_01(SFc10_Model_01InstanceStruct *chartInstance);
static void sf_gateway_c10_Model_01(SFc10_Model_01InstanceStruct *chartInstance);
static void initSimStructsc10_Model_01(SFc10_Model_01InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c10_machineNumber, uint32_T
  c10_chartNumber, uint32_T c10_instanceNumber);
static const mxArray *c10_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static void c10_emlrt_marshallIn(SFc10_Model_01InstanceStruct *chartInstance,
  const mxArray *c10_J, const char_T *c10_identifier, real_T c10_y[9]);
static void c10_b_emlrt_marshallIn(SFc10_Model_01InstanceStruct *chartInstance,
...
static const mxArray *c10_c_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static real_T c10_c_emlrt_marshallIn(SFc10_Model_01InstanceStruct *chartInstance,
...
static const mxArray *c10_d_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int32_T c10_d_emlrt_marshallIn(SFc10_Model_01InstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static uint8_T c10_e_emlrt_marshallIn(SFc10_Model_01InstanceStruct
  *chartInstance, const mxArray *c10_b_is_active_c10_Model_01, const char_T
  *c10_identifier);
static uint8_T c10_f_emlrt_marshallIn(SFc10_Model_01InstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void init_dsm_address_info(SFc10_Model_01InstanceStruct *chartInstance);
...
static void initialize_c10_Model_01(SFc10_Model_01InstanceStruct *chartInstance)
{
  ...
  chartInstance->c10_is_active_c10_Model_01 = 0U;
}
  ...
  *chartInstance)
{
  ...
  c10_hoistedGlobal = chartInstance->c10_is_active_c10_Model_01;
  ...
  *chartInstance, const mxArray *c10_st)
{
  ...
  chartInstance->c10_is_active_c10_Model_01 = c10_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c10_u, 1)),
     "is_active_c10_Model_01");
  sf_mex_destroy(&c10_u);
  c10_update_debugger_state_c10_Model_01(chartInstance);
  ...
  *c10_inData)
{
  ...
  real_T c10_u[9];
  const mxArray *c10_y = NULL;
  SFc10_Model_01InstanceStruct *chartInstance;
  chartInstance = (SFc10_Model_01InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c10_Model_01_get_eml_resolved_functions_info(void)
{
  ...
  *c10_identifier)
{
  ...
  c10_y = c10_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c10_b_is_active_c10_Model_01), &c10_thisId);
  sf_mex_destroy(&c10_b_is_active_c10_Model_01);
  return c10_y;
}
...
void sf_c10_Model_01_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c10_Model_01_get_autoinheritance_info(void)
{
...
mxArray *sf_c10_Model_01_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c10_Model_01_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c10_Model_01(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"J\",},{M[8],M[0],T\"is_active_c10_Model_01\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_Model_01_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc10_Model_01InstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c10_Model_01(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc10_Model_01InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c10_Model_01((SFc10_Model_01InstanceStruct*)
    chartInstanceVar);
  initialize_c10_Model_01((SFc10_Model_01InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c10_Model_01(void *chartInstanceVar)
{
  enable_c10_Model_01((SFc10_Model_01InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c10_Model_01(void *chartInstanceVar)
{
  disable_c10_Model_01((SFc10_Model_01InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c10_Model_01(void *chartInstanceVar)
{
  sf_gateway_c10_Model_01((SFc10_Model_01InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c10_Model_01(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c10_Model_01((SFc10_Model_01InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c10_Model_01();/* state var info */
...
extern void sf_internal_set_sim_state_c10_Model_01(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c10_Model_01();/* state var info */
  ...
  set_sim_state_c10_Model_01((SFc10_Model_01InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c10_Model_01(SimStruct* S)
{
  return sf_internal_get_sim_state_c10_Model_01(S);
}

static void sf_opaque_set_sim_state_c10_Model_01(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c10_Model_01(S, st);
}

static void sf_opaque_terminate_c10_Model_01(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_Model_01InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c10_Model_01((SFc10_Model_01InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc10_Model_01((SFc10_Model_01InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_Model_01(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c10_Model_01(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c10_Model_01(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c10_Model_01(SimStruct *S)
{
  SFc10_Model_01InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc10_Model_01InstanceStruct *)utMalloc(sizeof
    (SFc10_Model_01InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc10_Model_01InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c10_Model_01;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c10_Model_01;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c10_Model_01;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c10_Model_01;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c10_Model_01;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c10_Model_01;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c10_Model_01;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c10_Model_01;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_Model_01;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_Model_01;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c10_Model_01;
...
void c10_Model_01_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_Model_01(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_Model_01(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_Model_01(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_Model_01_method_dispatcher.\n"
