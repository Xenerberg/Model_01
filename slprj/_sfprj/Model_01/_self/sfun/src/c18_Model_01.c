...
static const char * c18_debug_family_names[6] = { "nargin", "nargout", "Pk", "K",
  "H", "Pkplus" };

/* Function Declarations */
static void initialize_c18_Model_01(SFc18_Model_01InstanceStruct *chartInstance);
static void initialize_params_c18_Model_01(SFc18_Model_01InstanceStruct
  *chartInstance);
static void enable_c18_Model_01(SFc18_Model_01InstanceStruct *chartInstance);
static void disable_c18_Model_01(SFc18_Model_01InstanceStruct *chartInstance);
static void c18_update_debugger_state_c18_Model_01(SFc18_Model_01InstanceStruct *
  chartInstance);
static const mxArray *get_sim_state_c18_Model_01(SFc18_Model_01InstanceStruct
  *chartInstance);
static void set_sim_state_c18_Model_01(SFc18_Model_01InstanceStruct
  *chartInstance, const mxArray *c18_st);
static void finalize_c18_Model_01(SFc18_Model_01InstanceStruct *chartInstance);
static void sf_gateway_c18_Model_01(SFc18_Model_01InstanceStruct *chartInstance);
static void initSimStructsc18_Model_01(SFc18_Model_01InstanceStruct
  *chartInstance);
...
static const mxArray *c18_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static void c18_emlrt_marshallIn(SFc18_Model_01InstanceStruct *chartInstance,
  const mxArray *c18_Pkplus, const char_T *c18_identifier, real_T c18_y[441]);
static void c18_b_emlrt_marshallIn(SFc18_Model_01InstanceStruct *chartInstance,
  const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId, real_T c18_y[441]);
...
static const mxArray *c18_d_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static real_T c18_c_emlrt_marshallIn(SFc18_Model_01InstanceStruct *chartInstance,
...
static void c18_eml_scalar_eg(SFc18_Model_01InstanceStruct *chartInstance);
static void c18_eml_xgemm(SFc18_Model_01InstanceStruct *chartInstance, real_T
  c18_A[126], real_T c18_B[126], real_T c18_C[441], real_T c18_b_C[441]);
static void c18_threshold(SFc18_Model_01InstanceStruct *chartInstance);
static void c18_b_eml_scalar_eg(SFc18_Model_01InstanceStruct *chartInstance);
static void c18_b_eml_xgemm(SFc18_Model_01InstanceStruct *chartInstance, real_T
  c18_A[441], real_T c18_B[441], real_T c18_C[441], real_T c18_b_C[441]);
static const mxArray *c18_e_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static int32_T c18_d_emlrt_marshallIn(SFc18_Model_01InstanceStruct
...
static void c18_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c18_mxArrayInData, const char_T *c18_varName, void *c18_outData);
static uint8_T c18_e_emlrt_marshallIn(SFc18_Model_01InstanceStruct
  *chartInstance, const mxArray *c18_b_is_active_c18_Model_01, const char_T
  *c18_identifier);
static uint8_T c18_f_emlrt_marshallIn(SFc18_Model_01InstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
static void c18_c_eml_xgemm(SFc18_Model_01InstanceStruct *chartInstance, real_T
  c18_A[126], real_T c18_B[126], real_T c18_C[441]);
static void c18_d_eml_xgemm(SFc18_Model_01InstanceStruct *chartInstance, real_T
  c18_A[441], real_T c18_B[441], real_T c18_C[441]);
static void init_dsm_address_info(SFc18_Model_01InstanceStruct *chartInstance);
...
static void initialize_c18_Model_01(SFc18_Model_01InstanceStruct *chartInstance)
{
  ...
  chartInstance->c18_is_active_c18_Model_01 = 0U;
}
  ...
  *chartInstance)
{
  ...
  real_T (*c18_Pkplus)[441];
  c18_Pkplus = (real_T (*)[441])ssGetOutputPortSignal(chartInstance->S, 1);
  c18_st = NULL;
  c18_st = NULL;
  c18_y = NULL;
  sf_mex_assign(&c18_y, sf_mex_createcellmatrix(2, 1), false);
  for (c18_i0 = 0; c18_i0 < 441; c18_i0++) {
    c18_u[c18_i0] = (*c18_Pkplus)[c18_i0];
  }

  c18_b_y = NULL;
  sf_mex_assign(&c18_b_y, sf_mex_create("y", c18_u, 0, 0U, 1U, 0U, 2, 21, 21),
                false);
  sf_mex_setcell(c18_y, 0, c18_b_y);
  c18_hoistedGlobal = chartInstance->c18_is_active_c18_Model_01;
  ...
  *chartInstance, const mxArray *c18_st)
{
  ...
  c18_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c18_u, 0)),
                       "Pkplus", c18_dv0);
  for (c18_i1 = 0; c18_i1 < 441; c18_i1++) {
    (*c18_Pkplus)[c18_i1] = c18_dv0[c18_i1];
  }

  chartInstance->c18_is_active_c18_Model_01 = c18_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c18_u, 1)),
     "is_active_c18_Model_01");
  sf_mex_destroy(&c18_u);
  c18_update_debugger_state_c18_Model_01(chartInstance);
...
static void sf_gateway_c18_Model_01(SFc18_Model_01InstanceStruct *chartInstance)
{
  ...
  int32_T c18_i22;
  int32_T c18_i23;
  real_T (*c18_b_Pkplus)[441];
  real_T (*c18_b_H)[126];
  real_T (*c18_b_K)[126];
  real_T (*c18_b_Pk)[441];
  c18_b_H = (real_T (*)[126])ssGetInputPortSignal(chartInstance->S, 2);
  c18_b_K = (real_T (*)[126])ssGetInputPortSignal(chartInstance->S, 1);
  c18_b_Pkplus = (real_T (*)[441])ssGetOutputPortSignal(chartInstance->S, 1);
  c18_b_Pk = (real_T (*)[441])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 17U, chartInstance->c18_sfEvent);
  for (c18_i2 = 0; c18_i2 < 441; c18_i2++) {
    _SFD_DATA_RANGE_CHECK((*c18_b_Pk)[c18_i2], 0U);
  }

  chartInstance->c18_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 17U, chartInstance->c18_sfEvent);
  for (c18_i3 = 0; c18_i3 < 441; c18_i3++) {
    c18_Pk[c18_i3] = (*c18_b_Pk)[c18_i3];
  }

  for (c18_i4 = 0; c18_i4 < 126; c18_i4++) {
    c18_K[c18_i4] = (*c18_b_K)[c18_i4];
  }

  for (c18_i5 = 0; c18_i5 < 126; c18_i5++) {
    c18_H[c18_i5] = (*c18_b_H)[c18_i5];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 6U, 6U, c18_debug_family_names,
    c18_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c18_nargin, 0U, c18_d_sf_marshallOut,
    c18_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c18_nargout, 1U, c18_d_sf_marshallOut,
    c18_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c18_Pk, 2U, c18_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c18_K, 3U, c18_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c18_H, 4U, c18_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c18_Pkplus, 5U, c18_sf_marshallOut,
    c18_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c18_sfEvent, 3);
  for (c18_i6 = 0; c18_i6 < 441; c18_i6++) {
    c18_I[c18_i6] = 0.0;
  }

  for (c18_k = 1; c18_k < 22; c18_k++) {
    c18_b_k = c18_k;
    c18_I[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
             (real_T)c18_b_k), 1, 21, 1, 0) + 21 * (_SFD_EML_ARRAY_BOUNDS_CHECK(
             "", (int32_T)_SFD_INTEGER_CHECK("", (real_T)c18_b_k), 1, 21, 2, 0)
            - 1)) - 1] = 1.0;
  }

  for (c18_i7 = 0; c18_i7 < 126; c18_i7++) {
    c18_a[c18_i7] = c18_K[c18_i7];
  }

  for (c18_i8 = 0; c18_i8 < 126; c18_i8++) {
    c18_b[c18_i8] = c18_H[c18_i8];
  }

  c18_eml_scalar_eg(chartInstance);
  c18_eml_scalar_eg(chartInstance);
  for (c18_i9 = 0; c18_i9 < 441; c18_i9++) {
    c18_y[c18_i9] = 0.0;
  }

  for (c18_i10 = 0; c18_i10 < 126; c18_i10++) {
    c18_b_a[c18_i10] = c18_a[c18_i10];
  }

  for (c18_i11 = 0; c18_i11 < 126; c18_i11++) {
    c18_b_b[c18_i11] = c18_b[c18_i11];
  }

  c18_c_eml_xgemm(chartInstance, c18_b_a, c18_b_b, c18_y);
  for (c18_i12 = 0; c18_i12 < 441; c18_i12++) {
    c18_I[c18_i12] -= c18_y[c18_i12];
  }

  for (c18_i13 = 0; c18_i13 < 441; c18_i13++) {
    c18_y[c18_i13] = c18_Pk[c18_i13];
  }

  c18_b_eml_scalar_eg(chartInstance);
  c18_b_eml_scalar_eg(chartInstance);
  for (c18_i14 = 0; c18_i14 < 441; c18_i14++) {
    c18_Pkplus[c18_i14] = 0.0;
  }

  for (c18_i15 = 0; c18_i15 < 441; c18_i15++) {
    c18_Pkplus[c18_i15] = 0.0;
  }

  for (c18_i16 = 0; c18_i16 < 441; c18_i16++) {
    c18_dv1[c18_i16] = c18_I[c18_i16];
  }

  for (c18_i17 = 0; c18_i17 < 441; c18_i17++) {
    c18_dv2[c18_i17] = c18_y[c18_i17];
  }

  for (c18_i18 = 0; c18_i18 < 441; c18_i18++) {
    c18_dv3[c18_i18] = c18_dv1[c18_i18];
  }

  for (c18_i19 = 0; c18_i19 < 441; c18_i19++) {
    c18_dv4[c18_i19] = c18_dv2[c18_i19];
  }

  c18_d_eml_xgemm(chartInstance, c18_dv3, c18_dv4, c18_Pkplus);
  _SFD_EML_CALL(0U, chartInstance->c18_sfEvent, -3);
  _SFD_SYMBOL_SCOPE_POP();
  for (c18_i20 = 0; c18_i20 < 441; c18_i20++) {
    (*c18_b_Pkplus)[c18_i20] = c18_Pkplus[c18_i20];
  }
  ...
  for (c18_i21 = 0; c18_i21 < 441; c18_i21++) {
    _SFD_DATA_RANGE_CHECK((*c18_b_Pkplus)[c18_i21], 1U);
  }

  for (c18_i22 = 0; c18_i22 < 126; c18_i22++) {
    _SFD_DATA_RANGE_CHECK((*c18_b_K)[c18_i22], 2U);
  }

  for (c18_i23 = 0; c18_i23 < 126; c18_i23++) {
    _SFD_DATA_RANGE_CHECK((*c18_b_H)[c18_i23], 3U);
  }
}
  ...
  *c18_inData)
{
  ...
  int32_T c18_i25;
  int32_T c18_i26;
  real_T c18_b_inData[441];
  int32_T c18_i27;
  int32_T c18_i28;
  int32_T c18_i29;
  real_T c18_u[441];
  const mxArray *c18_y = NULL;
  SFc18_Model_01InstanceStruct *chartInstance;
  chartInstance = (SFc18_Model_01InstanceStruct *)chartInstanceVoid;
  c18_mxArrayOutData = NULL;
  c18_i24 = 0;
  for (c18_i25 = 0; c18_i25 < 21; c18_i25++) {
    for (c18_i26 = 0; c18_i26 < 21; c18_i26++) {
      c18_b_inData[c18_i26 + c18_i24] = (*(real_T (*)[441])c18_inData)[c18_i26 +
        c18_i24];
    }
  ...
  c18_i27 = 0;
  for (c18_i28 = 0; c18_i28 < 21; c18_i28++) {
    for (c18_i29 = 0; c18_i29 < 21; c18_i29++) {
      c18_u[c18_i29 + c18_i27] = c18_b_inData[c18_i29 + c18_i27];
    }
  ...
  c18_y = NULL;
  sf_mex_assign(&c18_y, sf_mex_create("y", c18_u, 0, 0U, 1U, 0U, 2, 21, 21),
                false);
  ...
  const mxArray *c18_Pkplus, const char_T *c18_identifier, real_T c18_y[441])
{
  ...
  c18_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c18_Pkplus), &c18_thisId,
    c18_y);
  sf_mex_destroy(&c18_Pkplus);
}
  ...
  const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId, real_T c18_y[441])
{
  ...
  int32_T c18_i30;
  (void)chartInstance;
  sf_mex_import(c18_parentId, sf_mex_dup(c18_u), c18_dv5, 1, 0, 0U, 1, 0U, 2, 21,
                21);
  for (c18_i30 = 0; c18_i30 < 441; c18_i30++) {
    c18_y[c18_i30] = c18_dv5[c18_i30];
  }
  ...
  *c18_mxArrayInData, const char_T *c18_varName, void *c18_outData)
{
  ...
  SFc18_Model_01InstanceStruct *chartInstance;
  chartInstance = (SFc18_Model_01InstanceStruct *)chartInstanceVoid;
  c18_Pkplus = sf_mex_dup(c18_mxArrayInData);
  ...
  sf_mex_destroy(&c18_Pkplus);
  c18_i31 = 0;
  for (c18_i32 = 0; c18_i32 < 21; c18_i32++) {
    for (c18_i33 = 0; c18_i33 < 21; c18_i33++) {
      (*(real_T (*)[441])c18_outData)[c18_i33 + c18_i31] = c18_y[c18_i33 +
        c18_i31];
    }
  ...
  *c18_inData)
{
  ...
  c18_mxArrayOutData = NULL;
  c18_i34 = 0;
  for (c18_i35 = 0; c18_i35 < 21; c18_i35++) {
    for (c18_i36 = 0; c18_i36 < 6; c18_i36++) {
      c18_b_inData[c18_i36 + c18_i34] = (*(real_T (*)[126])c18_inData)[c18_i36 +
        c18_i34];
    }
  ...
  c18_i37 = 0;
  for (c18_i38 = 0; c18_i38 < 21; c18_i38++) {
    for (c18_i39 = 0; c18_i39 < 6; c18_i39++) {
      c18_u[c18_i39 + c18_i37] = c18_b_inData[c18_i39 + c18_i37];
    }
  ...
  c18_y = NULL;
  sf_mex_assign(&c18_y, sf_mex_create("y", c18_u, 0, 0U, 1U, 0U, 2, 6, 21),
                false);
  sf_mex_assign(&c18_mxArrayOutData, c18_y, false);
  return c18_mxArrayOutData;
}
  ...
  *c18_inData)
{
  ...
  c18_mxArrayOutData = NULL;
  c18_i40 = 0;
  for (c18_i41 = 0; c18_i41 < 6; c18_i41++) {
    for (c18_i42 = 0; c18_i42 < 21; c18_i42++) {
      c18_b_inData[c18_i42 + c18_i40] = (*(real_T (*)[126])c18_inData)[c18_i42 +
        c18_i40];
    }
  ...
  c18_i43 = 0;
  for (c18_i44 = 0; c18_i44 < 6; c18_i44++) {
    for (c18_i45 = 0; c18_i45 < 21; c18_i45++) {
      c18_u[c18_i45 + c18_i43] = c18_b_inData[c18_i45 + c18_i43];
    }
  ...
  c18_y = NULL;
  sf_mex_assign(&c18_y, sf_mex_create("y", c18_u, 0, 0U, 1U, 0U, 2, 21, 6),
                false);
  sf_mex_assign(&c18_mxArrayOutData, c18_y, false);
  return c18_mxArrayOutData;
}
...
const mxArray *sf_c18_Model_01_get_eml_resolved_functions_info(void)
{
  const mxArray *c18_nameCaptureInfo = NULL;
  c18_nameCaptureInfo = NULL;
  sf_mex_assign(&c18_nameCaptureInfo, sf_mex_createstruct("structure", 2, 34, 1),
                false);
...
static void c18_info_helper(const mxArray **c18_info)
{
  ...
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 17);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("intmax"), "name", "name", 17);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 17);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c18_info, sf_mex_duplicatearraysafe(&c18_lhs17), "lhs", "lhs",
                  17);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(""), "context", "context", 18);
  ...
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(1375987890U), "fileTimeLo",
                  "fileTimeLo", 23);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 23);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/xgemm.p!below_threshold"),
                  "context", "context", 27);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "coder.internal.blas.threshold"), "name", "name", 27);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 27);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/xgemm.p"),
                  "context", "context", 30);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "coder.internal.refblas.xgemm"), "name", "name", 30);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 30);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/xgemm.p!ceval_xgemm"),
                  "context", "context", 32);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "coder.internal.blas.size_ptr"), "name", "name", 32);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(""), "dominantType",
                  "dominantType", 32);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
  ...
  c18_A[126], real_T c18_B[126], real_T c18_C[441], real_T c18_b_C[441])
{
  ...
  int32_T c18_i48;
  real_T c18_b_B[126];
  for (c18_i46 = 0; c18_i46 < 441; c18_i46++) {
    c18_b_C[c18_i46] = c18_C[c18_i46];
  }

  for (c18_i47 = 0; c18_i47 < 126; c18_i47++) {
    c18_b_A[c18_i47] = c18_A[c18_i47];
  }

  for (c18_i48 = 0; c18_i48 < 126; c18_i48++) {
    c18_b_B[c18_i48] = c18_B[c18_i48];
  }

  c18_c_eml_xgemm(chartInstance, c18_b_A, c18_b_B, c18_b_C);
}
  ...
  c18_A[441], real_T c18_B[441], real_T c18_C[441], real_T c18_b_C[441])
{
  ...
  int32_T c18_i51;
  real_T c18_b_B[441];
  for (c18_i49 = 0; c18_i49 < 441; c18_i49++) {
    c18_b_C[c18_i49] = c18_C[c18_i49];
  }

  for (c18_i50 = 0; c18_i50 < 441; c18_i50++) {
    c18_b_A[c18_i50] = c18_A[c18_i50];
  }

  for (c18_i51 = 0; c18_i51 < 441; c18_i51++) {
    c18_b_B[c18_i51] = c18_B[c18_i51];
  }

  c18_d_eml_xgemm(chartInstance, c18_b_A, c18_b_B, c18_b_C);
}
  ...
  *c18_identifier)
{
  ...
  c18_y = c18_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c18_b_is_active_c18_Model_01), &c18_thisId);
  sf_mex_destroy(&c18_b_is_active_c18_Model_01);
  return c18_y;
}
  ...
  c18_A[126], real_T c18_B[126], real_T c18_C[441])
{
  ...
  c18_TRANSB = 'N';
  c18_TRANSA = 'N';
  c18_m_t = (ptrdiff_t)(21);
  c18_n_t = (ptrdiff_t)(21);
  c18_k_t = (ptrdiff_t)(6);
  c18_lda_t = (ptrdiff_t)(21);
  c18_ldb_t = (ptrdiff_t)(6);
  c18_ldc_t = (ptrdiff_t)(21);
  c18_alpha1_t = (double *)(&c18_alpha1);
  c18_Aia0_t = (double *)(&c18_A[0]);
  c18_Bib0_t = (double *)(&c18_B[0]);
  c18_beta1_t = (double *)(&c18_beta1);
  c18_Cic0_t = (double *)(&c18_C[0]);
  dgemm(&c18_TRANSA, &c18_TRANSB, &c18_m_t, &c18_n_t, &c18_k_t, c18_alpha1_t,
        c18_Aia0_t, &c18_lda_t, c18_Bib0_t, &c18_ldb_t, c18_beta1_t, c18_Cic0_t,
        &c18_ldc_t);
}
  ...
  c18_A[441], real_T c18_B[441], real_T c18_C[441])
{
  ...
  c18_m_t = (ptrdiff_t)(21);
  c18_n_t = (ptrdiff_t)(21);
  c18_k_t = (ptrdiff_t)(21);
  c18_lda_t = (ptrdiff_t)(21);
  c18_ldb_t = (ptrdiff_t)(21);
  c18_ldc_t = (ptrdiff_t)(21);
  c18_alpha1_t = (double *)(&c18_alpha1);
  c18_Aia0_t = (double *)(&c18_A[0]);
  c18_Bib0_t = (double *)(&c18_B[0]);
...
void sf_c18_Model_01_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(329875961U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3919605274U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3363357712U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4239717278U);
}

mxArray *sf_c18_Model_01_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("06BKYiKMrCeapG4pb5meFD");
...
mxArray *sf_c18_Model_01_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c18_Model_01_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c18_Model_01(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Pkplus\",},{M[8],M[0],T\"is_active_c18_Model_01\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c18_Model_01_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc18_Model_01InstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,2,0,1,"Pkplus");
...

        {
          ...
          real_T (*c18_K)[126];
          real_T (*c18_H)[126];
          c18_H = (real_T (*)[126])ssGetInputPortSignal(chartInstance->S, 2);
          c18_K = (real_T (*)[126])ssGetInputPortSignal(chartInstance->S, 1);
          c18_Pkplus = (real_T (*)[441])ssGetOutputPortSignal(chartInstance->S,
            1);
          c18_Pk = (real_T (*)[441])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c18_Pk);
          _SFD_SET_DATA_VALUE_PTR(1U, *c18_Pkplus);
          _SFD_SET_DATA_VALUE_PTR(2U, *c18_K);
          _SFD_SET_DATA_VALUE_PTR(3U, *c18_H);
        }
      }
    } else {
...
{
  return "9ED3OSWUWBvLguXkiXLqRC";
}

static void sf_opaque_initialize_c18_Model_01(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc18_Model_01InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c18_Model_01((SFc18_Model_01InstanceStruct*)
    chartInstanceVar);
  initialize_c18_Model_01((SFc18_Model_01InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c18_Model_01(void *chartInstanceVar)
{
  enable_c18_Model_01((SFc18_Model_01InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c18_Model_01(void *chartInstanceVar)
{
  disable_c18_Model_01((SFc18_Model_01InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c18_Model_01(void *chartInstanceVar)
{
  sf_gateway_c18_Model_01((SFc18_Model_01InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c18_Model_01(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c18_Model_01((SFc18_Model_01InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c18_Model_01();/* state var info */
...
extern void sf_internal_set_sim_state_c18_Model_01(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c18_Model_01();/* state var info */
  ...
  set_sim_state_c18_Model_01((SFc18_Model_01InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c18_Model_01(SimStruct* S)
{
  return sf_internal_get_sim_state_c18_Model_01(S);
}

static void sf_opaque_set_sim_state_c18_Model_01(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c18_Model_01(S, st);
}

static void sf_opaque_terminate_c18_Model_01(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc18_Model_01InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c18_Model_01((SFc18_Model_01InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc18_Model_01((SFc18_Model_01InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c18_Model_01(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c18_Model_01(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3146887678U));
  ssSetChecksum1(S,(253220994U));
  ssSetChecksum2(S,(136442823U));
  ssSetChecksum3(S,(4080506063U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c18_Model_01(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c18_Model_01(SimStruct *S)
{
  SFc18_Model_01InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc18_Model_01InstanceStruct *)utMalloc(sizeof
    (SFc18_Model_01InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc18_Model_01InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c18_Model_01;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c18_Model_01;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c18_Model_01;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c18_Model_01;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c18_Model_01;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c18_Model_01;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c18_Model_01;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c18_Model_01;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c18_Model_01;
  chartInstance->chartInfo.mdlStart = mdlStart_c18_Model_01;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c18_Model_01;
...
void c18_Model_01_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c18_Model_01(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c18_Model_01(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c18_Model_01(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c18_Model_01_method_dispatcher.\n"
